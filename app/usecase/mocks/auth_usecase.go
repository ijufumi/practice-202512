...
func (_mock *MockAuthUsecase) Login(ctx context.Context, email string, password string) (string, error) {
...
//   - email string
//   - password string
func (_e *MockAuthUsecase_Expecter) Login(ctx interface{}, email interface{}, password interface{}) *MockAuthUsecase_Login_Call {
	return &MockAuthUsecase_Login_Call{Call: _e.mock.On("Login", ctx, email, password)}
}

func (_c *MockAuthUsecase_Login_Call) Run(run func(ctx context.Context, email string, password string)) *MockAuthUsecase_Login_Call {
...
func (_c *MockAuthUsecase_Login_Call) Return(s string, err error) *MockAuthUsecase_Login_Call {
	_c.Call.Return(s, err)
	return _c
}

func (_c *MockAuthUsecase_Login_Call) RunAndReturn(run func(ctx context.Context, email string, password string) (string, error)) *MockAuthUsecase_Login_Call {
	_c.Call.Return(run)
	return _c
}
